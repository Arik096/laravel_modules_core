...
@section('content')
{{Form::open(['route'=>['core.modules.update',$prefix,$data->id],'method'=>'PUT','files'=>true])}}
                ...
                <div class="col" style="margin-top: 40px; padding-left: 40px;">
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" name="title" value="{{$data->title}}" class="form-control i-f-d" placeholder="Write your module name">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                @if($data->upload_icon != "")
                                    <img id="changeImageDesktop" src="{{asset('public/uploads/module-icon/'.$data->upload_icon)}}" height="50px" width="50px;"/>
                                @else
