...
@endsection
@section('content')
    {{Form::open(['route'=>['core.users.update',$prefix,$data->id],'method'=>'PUT'])}}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="name_en" value="{{$data->getTranslation('name', 'en')}}" class="form-control i-f-d" placeholder="Write your name">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">User Name <span style="color: silver">(Bangla)</span></label>
                                    <input type="text" name="name_bn" value="{{$data->getTranslation('name', 'bn')}}" class="form-control i-f-d" placeholder="Write your name">
                                </div>
                            ...
                            <div class="mb-5" style="margin-top: 30px;">
                                ...
                                <select name="role_id"  class="form-select i-f-d js-example-basic-single">
                                    ...
                                    @foreach($roles as $role)
                                        @if($role->id == $data->spatie_role_id)
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" name="mobile" value="{{$data->mobile}}" class="form-control i-f-d" placeholder="Write your mobile number">
                            </div>


                            <div class="mb-5">
                                <label class="form-label">Email</label>
                                <input type="text" name="email" value="{{$data->email}}" class="form-control i-f-d" placeholder="Write your email">
                            </div>
