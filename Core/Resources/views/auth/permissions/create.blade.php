...
@section('content')
    ...
    {{Form::open(['route'=>['core.permissions.store',$prefix],'method'=>'POST','files'=>true])}}
                    ...
                    <div class="col" style="margin-top: 40px; padding-left: 40px;">
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" name="name" class="form-control i-f-d" placeholder="Write your Permission name">
                                </div>

                            @livewire('core::permission.create')
